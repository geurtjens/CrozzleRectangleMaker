...
public class Rectangle2Calculator {
    ...
    public static func TopLeftRectangle(interlockWidth: Int, interlockHeight: Int, letterIndex: LetterIndexModel, words: [String], lengths: [Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [RectangleModel] {
        /*
              .AZURE
              S I
        DECORATIONS
...
//                                print("right word:\(words[right.wordId]), interlock:\(rightInterlock)")
    ...
    public static func TopLeftSquare(interlockWidth: Int, letterIndex: LetterIndexModel, words: [String], lengths: [Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [RectangleModel] {
        /*
              .AZURE
              S I
        DECORATIONS
