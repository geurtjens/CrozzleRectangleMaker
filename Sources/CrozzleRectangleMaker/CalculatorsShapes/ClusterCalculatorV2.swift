...
import Foundation
public class ClusterCalculatorV2 {
    ...
    public static func ExecuteAllSerial(scoreMin: Int, includeBreakdown: Bool = true) -> Int {
        ...
        for game in gameList.games {
            ...
            if includeBreakdown {
                print("CusterCalculatorV2.Execute: \(game.gameId), count: \(clusters.count)")
            }
        ...
        print("ClusterCalculatorV2.Execute: \(count) records found in \(duration)")
        return count
    }
