...
import Foundation
public class OuterCalculatorV3 {
...
//            }
        ...
        print("OuterCalculatorV3.Execute: produced \(shapesFromWinningWordsCount) winning word shapes and \(shapesFromWordsCount) words shapes in \(duration)")
    ...
    public static func Execute(words: [String], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        ...
        let c2x3 = C2x3(letterIndex: letterIndex, words: wordsInt, end: endInt, words2: words, end2: end, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let c2x4 = C2x4(letterIndex: letterIndex, words: wordsInt, end: endInt, words2: words, end2: end, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        
        let result = c2x3 + c2x4
        return result
    }
    
    public static func C2x3(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len:[Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        
        let LRL_MO = C2x3_LRL_MO(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let LRL_OM = C2x3_LRL_OM(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let RLR_MO = C2x3_RLR_MO(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let RLR_OM = C2x3_RLR_OM(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
    ...
    public static func C2x4(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len:[Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        
        let LRL_MO = C2x4_LRLR_MO(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let LRL_OM = C2x4_LRLR_OM(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let RLR_MO = C2x4_RLRL_MO(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
        let RLR_OM = C2x4_RLRL_OM(letterIndex: letterIndex, words: words, end: end, words2: words2, end2: end2, len: len, scoreMin: scoreMin, widthMax: widthMax, heightMax: heightMax)
    ...
    public static func C2x3_LRL_MO(letterIndex:LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len:[Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        ...
        for _middle1 in 0..<wordCount {
            ...
            if (len[_middle1] == interlockHeight) {
                ...
                let left1Words = letterIndex.find3(words[_middle1][0])
                            ...
                            if (len[_outer2] >= interlockHeight+2 &&
                                ...
                                for outerPos2 in 1..<(len[_outer2]-interlockHeight) {
                                    ...
                                    if words[_outer2][outerPos2 + 0] == end[left1.id][0] {
                                        ...
                                        let right2Words = letterIndex.find3(words[_middle1][1])
                                        for right2 in right2Words {
                                            ...
                                            if (right2.start == 0 && //words[right2.id][0] == words[_middle1][1] &&
                                                ...
                                                let left3Words = letterIndex.find3(words[_middle1][2])
    ...
    public static func C2x3_LRL_OM(letterIndex:LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len:[Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        ...
        for _outer1 in 0..<wordCount {
            ...
            if (len[_outer1] >= interlockHeight + 2) {
                ...
                for outerPos1 in 1..<(len[_outer1] - interlockHeight) {
                    ...
                    let left1Words = letterIndex.find3(words[_outer1][outerPos1])
                    for left1 in left1Words {
                        ...
                        if (left1.end == 1 &&//end[left1][1] == words[_outer1][outerPos1 + 0] &&
                            ...
                            let middle2Words = letterIndex.find3(end[left1.id][0])
                            for middle2 in middle2Words {
                                ...
                                if (middle2.start == 0 && //words[middle2][0] == end[left1][0] &&
                                    ...
                                    let right2Words = letterIndex.find3(words[_outer1][outerPos1 + 1])
                                    for right2 in right2Words {
                                        ...
                                        if (right2.start == 0 && //words[right2][0] == words[_outer1][outerPos1 + 1] &&
                                            ...
                                            let left3Words = letterIndex.find3(words[_outer1][outerPos1 + 2])
                                            for left3 in left3Words {
    ...
    public static func C2x3_RLR_OM(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len: [Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        ...
        for _outer1 in 0..<wordCount {
             ...
             if (len[_outer1] >= interlockHeight + 2) {
                 ...
                 for outerPos1 in 1..<(len[_outer1]-interlockHeight) {
                     ...
                     let right1Words = letterIndex.find3(words[_outer1][outerPos1 + 0])
                     for right1 in right1Words {
                         ...
                         if (right1.start == 0 && //words[right1][0] == words[_outer1][outerPos1 + 0] &&
                             ...
                             let middle2Words = letterIndex.find3(words[right1.id][1])
                             for middle2 in middle2Words {
                                 ...
                                 if (middle2.start == 0 && //words[middle2][0] == words[right1][1] &&
                                     ...
                                     let left2Words = letterIndex.find3(words[middle2.id][1])
                                     for left2 in left2Words {
                                         ...
                                         if (left2.end == 0 && //end[left2][0] == words[middle2][1] &&
                                             ...
                                             let right3Words = letterIndex.find3(words[middle2.id][2])
    ...
    public static func C2x3_RLR_MO(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len: [Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        ...
        for _middle1 in 0..<wordCount {
             ...
             if (len[_middle1] == interlockHeight) {
                 ...
                 let right1Words = letterIndex.find3(words[_middle1][0])
                 for right1 in right1Words {
                             ...
                             if (len[_outer2] >= interlockHeight + 2 &&
                                 ...
                                 for outerPos2 in 1..<(len[_outer2] - interlockHeight) {
                                     ...
                                     if words[_outer2][outerPos2 + 0] == words[right1.id][1] {
                                         ...
                                         let left2Words = letterIndex.find3(words[_outer2][outerPos2 + 1])
                                         for left2 in left2Words {
                                             ...
                                             if (left2.end == 0 && // end[left2][0] == words[outer2][outerPos2 + 1] &&
                                                 ...
                                                 let right3Words = letterIndex.find3(words[_middle1][2])
                                                 for right3 in right3Words {
    ...
    public static func C2x4_RLRL_MO(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len: [Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
                                     ...
                                     if words[_outer2][outerPos2 + 0] == words[right1.id][1] {
                                         ...
                                         for left2 in left2Words {
                                             ...
                                             if (left2.end == 0 && //end[left2.id][0] == words[outer2][outerPos2 + 1] &&
                                                 ...
                                                 let right3Words = letterIndex.find3(words[_outer2][outerPos2 + 2])
                                                 for right3 in right3Words {
                                                     ...
                                                     if (right3.start == 1 && //words[right3.id][1] == words[outer2][outerPos2 + 2] &&
                                                        len[right3.id] >= interlockWidth &&
                                                         ...
                                                         let left4Words = letterIndex.find3(words[_outer2][outerPos2 + 3])
    ...
    public static func C2x4_RLRL_OM(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len: [Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
                                        ...
                                        if (left2.end == 0 && //end[left2.id][0] == words[middle2.id][1] &&
                                            ...
                                            for right3 in right3Words {
                                                ...
                                                if (right3.start == 1 && //words[right3.id][1] == words[middle2.id][2] &&
                                                    ...
                                                    let left4Words = letterIndex.find3(words[middle2.id][3])
                                                     for left4 in left4Words {
    ...
    public static func C2x4_LRLR_OM(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len:[Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
        ...
        for _outer1 in 0..<wordCount {
            ...
            if (len[_outer1] >= interlockHeight + 2) {
                ...
                for outerPos1 in 1..<(len[_outer1] - interlockHeight) {
                    ...
                    let left1Words = letterIndex.find3(words[_outer1][outerPos1 + 0])
                    for left1 in left1Words {
                        ...
                        if (left1.end == 1 && //end[left1.id][1] == words[_outer1][outerPos1 + 0] &&
                            ...
                            for middle2 in middle2Words {
                                ...
                                if (middle2.start == 0 && //words[middle2.id][0] == end[left1.id][0] &&
                                    ...
                                    let right2Words = letterIndex.find3(words[middle2.id][1])
                                    for right2 in right2Words {
                                        ...
                                        if (right2.start == 1 && //words[right2.id][1] == words[middle2.id][1] &&
                                            ...
                                            let left3Words = letterIndex.find3(words[middle2.id][2])
                                            for left3 in left3Words {
                                                ...
                                                if (left3.end == 0 && //end[left3.id][0] == words[middle2.id][2] &&
                                                    ...
                                                    let right4Words = letterIndex.find3(words[middle2.id][3])
    ...
    public static func C2x4_LRLR_MO(letterIndex: LetterIndexModel, words: [[Int]], end: [[Int]], words2: [String], end2: [String], len:[Int], scoreMin: Int, widthMax: Int, heightMax: Int) -> [OuterModel] {
                            ...
                            if (len[outer2] >= interlockHeight + 2 &&
                                ...
                                for outerPos2 in 1..<(len[outer2] - interlockHeight) {
                                    if (words[outer2][outerPos2 + 0] == end[left1.id][0]) {
                                        ...
                                        let right2Words = letterIndex.find3(words[outer2][outerPos2 + 1])
                                        for right2 in right2Words {
                                            ...
                                            if (right2.start == 1 && //words[right2.id][1] == words[outer2][outerPos2 + 1] &&
                                                ...
                                                for left3 in left3Words {
                                                    ...
                                                    if (left3.end == 1 && // end[left3.id][1] == words[_middle1][2] &&
                                                        ...
                                                        let right4Words = letterIndex.find3(words[_middle1][3])
                                                        for right4 in right4Words {
