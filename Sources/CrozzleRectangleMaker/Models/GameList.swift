...
public struct GameList {
    ...
    public init() {
       ...
       nonWinningWords:["EMBEZZLE", "GAZUMP", "SQUEEZE", "PROXY", "MONEY", "ASSETS", "PAYMENT", "TRUSTEE", "MONOPOLY", "QUOTE", "PROSPECTUS", "CURRENCY", "INVESTMENT", "JUMP", "DISCOUNT", "INTEREST", "SETTLEMENT", "FUNDS", "YIELD", "OPTION", "RIGHTS", "SECURITIES", "REPORT", "SHARES", "DEPOSIT", "LIABILITY", "CONTRACT", "ACCOUNT", "PREMIUM", "RESERVE", "REVENUE", "PROFIT", "VENDOR", "MARKET", "GUARANTEE", "BOOM", "DEBENTURE", "AGENT", "DRAWER", "DEFAULT", "CREDITOR", "INFLATION", "RING", "CORNER", "RECEIPT", "CARTEL", "CHEQUE", "CREDIT", "MARGIN", "ORDER", "FIRM", "PERCENTAGE", "BROKER", "INCOME", "MERGER", "COLLATERAL", "AVERAGE", "BOND", "DIVIDEND", "EXCHANGE", "PRICE", "ADVICE", "GOLD", "OFFER", "BANKER", "JOBBER", "BANK", "FINANCE", "BILL", "BALANCE", "CALL", "DEAL"],
        ...
        games.append(GameModel(gameId:8710, title: "", maxWidth:17, maxHeight:12, winningScore:764, isValid: true, tags:["P","P33","C","C22","C23"],
        ...
        games.append(GameModel(gameId:8803, title: "Cities", maxWidth:17, maxHeight:12, winningScore:626, isValid: true, tags:["P","P33","C","C22"],
        ...
        games.append(GameModel(gameId:8907, title: "", maxWidth:17, maxHeight:12, winningScore:818, isValid: true, tags:["P","P33","C","C23"],
        ...
        games.append(GameModel(gameId:8911, title: "Racing", maxWidth:17, maxHeight:12, winningScore:692, isValid: true, tags:["P","P33","C","C33"],
        ...
        games.append(GameModel(gameId:9002, title: "Food", maxWidth:17, maxHeight:12, winningScore:714, isValid: true, tags:["P","P34"],
        ...
        games.append(GameModel(gameId:9209, title: "War", maxWidth:17, maxHeight:12, winningScore:608, isValid: true, tags:["P","P33","C","C43"],
        ...
        games.append(GameModel(gameId:9410, title: "", maxWidth:17, maxHeight:15, winningScore:688, isValid: true, tags:["P","P33"],
        ...
        games.append(GameModel(gameId:9511, title: "", maxWidth:17, maxHeight:15, winningScore:772, isValid: true, tags:["P","P33"],
