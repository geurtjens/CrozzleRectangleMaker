...
public struct GameList {
    ...
    public init() {
       ...
       nonWinningWords:["EMBEZZLE", "GAZUMP", "SQUEEZE", "PROXY", "MONEY", "ASSETS", "PAYMENT", "TRUSTEE", "MONOPOLY", "QUOTE", "PROSPECTUS", "CURRENCY", "INVESTMENT", "JUMP", "DISCOUNT", "INTEREST", "SETTLEMENT", "FUNDS", "YIELD", "OPTION", "RIGHTS", "SECURITIES", "REPORT", "SHARES", "DEPOSIT", "LIABILITY", "CONTRACT", "ACCOUNT", "PREMIUM", "RESERVE", "REVENUE", "PROFIT", "VENDOR", "MARKET", "GUARANTEE", "BOOM", "DEBENTURE", "AGENT", "DRAWER", "DEFAULT", "CREDITOR", "INFLATION", "RING", "CORNER", "RECEIPT", "CARTEL", "CHEQUE", "CREDIT", "MARGIN", "ORDER", "FIRM", "PERCENTAGE", "BROKER", "INCOME", "MERGER", "COLLATERAL", "AVERAGE", "BOND", "DIVIDEND", "EXCHANGE", "PRICE", "ADVICE", "GOLD", "OFFER", "BANKER", "JOBBER", "BANK", "FINANCE", "BILL", "BALANCE", "CALL", "DEAL"],
        ...
        games.append(GameModel(gameId:8807, title: "", maxWidth:17, maxHeight:12, winningScore:764, isValid: true, tags:[],
        ...
        games.append(GameModel(gameId:8907, title: "", maxWidth:17, maxHeight:12, winningScore:818, isValid: true, tags:["P","P33","C","C23","Packman3x3_BottomRight"],
        ...
        games.append(GameModel(gameId:8910, title: "", maxWidth:17, maxHeight:12, winningScore:576, isValid: true, tags:[],
        ...
        games.append(GameModel(gameId:9008, title: "Wood", maxWidth:17, maxHeight:12, winningScore:592, isValid: true, tags:[],
        ...
        games.append(GameModel(gameId:9508, title: "", maxWidth:17, maxHeight:15, winningScore:778, isValid: true, tags:[],
        ...
        games.append(GameModel(gameId:9601, title: "", maxWidth:17, maxHeight:15, winningScore:830, isValid: true, tags:[],
        winningWords:[
        ...
        games.append(GameModel(gameId:9604, title: "", maxWidth:17, maxHeight:15, winningScore:720, isValid: true, tags:[],
