...
public struct GameList {
    ...
    public init() {
        ...
        winningWords:[],
        nonWinningWords:["ZINNIA","MAY","ALYSSUM","SOW","PANSY","POPPY","AZALEA","GAZANIA","LOTUS","PEONY","DAISY","LILY","POT","PEST","STEM","SHRUBS","BLOSSUM","BOUQUET","DISPLAY","TULIP","WATTLE","SNOWDROP","GRASS","STOCK","NATIVES","TRIM","CACTUS","HYACINTH","ASTER","SWEEP","TREES","TUBER","WATER","TAP","CROCUS","ROSE","MOWER","STALK","VIOLET","LARKSPUR","IRIS","SOIL","FLOWERS","HIBISCUS","MIMOSA","PLANT","ROCKS","ALOW","HOSE","LAWN","PATH","VINE","CYCLAMEN","JONQUIL","SALVIA","NITROGEN","HYDRANGEA","POOL","JASMIN","BROOM","MULCH","VIOLA","SPRINKLE","BUD","ANNUAL","BONSAI","LILIUM","CORN","IXIA","PLUMBAGO","CARNATION","EARTH","DISEASE","SAXIFRAGE","BULB","PINK","BLOOM","PRIME","SPADE","VERBENA","BALSAM","FORK","PALM","SEED","WEED","ANEMONE","PREPARE","EDGES","FREESIA","ORGANIC","LANDSCAPE","PERENNIAL","FERN","MARIGOLD","DRAIN","GREEN","HOE","ORCHID","CALENDULA","CANNA","GARDEN","BEGONIA","CLIMBER","CAN","RAKE","GARDENIA","CLARKIA","LOBELIA","CAMELLIA","DIG","DAFFODIL","LILAC","DAKLIA","LEAF","ACACIA","BED"],
        winningGame: [
            "      AzAlEA   ",
            "  ALOw I E  P P",
            " V   aNnUaL O O",
        ...
        winningWords:[],
        nonWinningWords:["DYNASTY","ROYALTY","CZARINA","MAJESTY","ELIZABETH","HENRY","COUNTESS","SULTAN","XERXES","LOUIS","ARTHUR","CHIVALRY","MARQUIS","WINDSOR","MINOS","CEREMONY","EMPRESS","SOLOMON","TIBERIUS","CROWN","DUCHESS","ROMANOV","CONSTANTINE","STEPHEN","COURTIER","PRINCESS","GOVERNMENT","TUTANKHAMEN","MAGISTRATE","CLAUDIUS","PROTOCOL","SCEPTRE","CANUTE","LUDWIG","THRONE","SOVEREIGN","WENCESLAS","IVAN","RULE","VICTORIA","CORONET","FOOTMAN","ATTILA","PRESIDENT","PETER","QUEEN","CORONATION","BEATRIX","CHRISTINA","STANDARD","ALFONSO","GARTER","KNIGHT","REGENT","JAMES","MIDAS","JEHOSHAPHAT","DUNCAN","EMPEROR","ETHELBERT","PARLIAMENT","HARDINCANUTE","DUKE","MAJOR","PRIAM","KAISER","OBERON","DICATOR","NICHOLAS","HAMMURABI","CLEOPATRA","GUARDIAN","MONARCH","JUDGE","LORD","RANI","CHARLES","KINGDOM","SHERIFF","CAESAR","EDWARD","EMPIRE","CATHERINE","COMMANDER","DAVID","CABINET","LEOPOLD","PHARAOH","ALEXANDER","KING","BANNER","ETHELRED","HEROD","CALIGULA","CAROLINE","GEORGE","HAROLD","MIKADO","CHANCELLOR","RICHARD","CHAMBERLAIN","COLE","RAJAH","CALIPH","OFFICER","MAHARAJAH","FREDERICK","ALARIC","ALFRED","PALACE","BOADICEA"],
        winningGame: [
            "V  MiDAS  H A  ",
            "I C V   O E T  ",
            "C O A CAbInEt  ",
